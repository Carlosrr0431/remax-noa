                ...
                <table class="w-full  text-left table-auto min-w-max">
                    ...
                    <tbody>
                        {usuariosFilter && estado == 'Activos' ? (usuariosFilter?.filter(e => {
                            if (e.tipoPlan == "Basico") {
                                if (e.dias < 8)
                                    return true
                                else return false
                            } else if (e.tipoPlan == "Semi Intenso") {
                                if (e.dias < 12)
                                    return true
                                else return false
                            ...
                            <tr key={index}>
                                ...
                                <td class="p-4 border-b border-blue-gray-50">
                                    <div class="flex flex-col">
                                        ...
                                        <p class="block font-sans text-sm antialiased font-normal leading-normal text-blue-gray-900">
                                            {elem.dias} / {elem.tipoPlan == 'Basico' ? 8 : elem.tipoPlan == "Semi Intenso" ? 12 : elem.tipoPlan == "Super Intenso" ? 16 : null}
                                        </p>
                                ...
                                <td class="p-4 border-b border-blue-gray-50">
                                    <div class="w-max">
                                        ...
                                        {
                                            elem.tipoPlan == 'Basico' ? elem.dias < 8 ? (<div
                                            ...
                                            </div>) : elem.tipoPlan == 'Semi Intenso' ? elem.dias < 12 ? (<div
                                                class="relative grid items-center px-2 py-1 font-sans text-xs font-bold text-green-500 uppercase rounded-md select-none whitespace-nowrap bg-green-500/20">
                                                <span class="">Activo</span>
                                            </div>) : (<div
                                                class="relative grid items-center px-2 py-1 font-sans text-xs font-bold uppercase rounded-md select-none whitespace-nowrap bg-red-800/20 text-red-800">
                                                <span class="">Inactivo</span>
                                            </div>) : elem.tipoPlan == 'Super Intenso' ? elem.dias < 16 ? (<div
                                                class="relative grid items-center px-2 py-1 font-sans text-xs font-bold text-green-500 uppercase rounded-md select-none whitespace-nowrap bg-green-500/20">
                                                <span class="">Activo</span>
                                            </div>) : (<div
                                                class="relative grid items-center px-2 py-1 font-sans text-xs font-bold uppercase rounded-md select-none whitespace-nowrap bg-red-800/20 text-red-800">
                                ...
                                <td class="p-4 border-b border-blue-gray-50">
                                    ...
                                    {
                                        (elem.tipoPlan == 'Basico' && elem.dias < 8 && establecerFecha(elem.fechaIngreso) >= 1) ? (<button
                                            onClick={async () => {
                                        ...
                                        </button>)) : (elem.dias >= 8 && elem.tipoPlan == 'Basico') ? (<button
                                            onClick={() => {
                                                setShowModal2(true),
                                                    setInfo({
                                    ...
                                    {
                                        (elem.tipoPlan == 'Semi Intenso' && elem.dias < 12 && establecerFecha(elem.fechaIngreso) >= 1) ? (<button
                                            onClick={async () => {
                                                await registrarIngreso(elem.dias + 1, elem.id), toast.custom((t) => (
                                                    <div className='bg-white p-4 rounded-md text-black relative'>
                                                        <button className='' onClick={() => toast.dismiss(t)}><AiOutlineClose className='w-4 h-4  absolute left-[92%] top-[10%]' /></button>
                                        ...
                                        </button>) : (establecerFecha(elem.fechaIngreso) == 0 && elem.tipoPlan == 'Semi Intenso' && elem.dias < 12 ? ((<button
                                            onClick={() =>
                                                toast.custom((t) => (
                                                    <div className='bg-white p-4 rounded-md text-black relative'>
                                                        <button className='' onClick={() => toast.dismiss(t)}><AiOutlineClose className='w-4 h-4  absolute left-[92%] top-[10%]' /></button>
                                        ...
                                        </button>)) : (elem.dias >= 12 && elem.tipoPlan == 'Semi Intenso') ? (<button
                                            onClick={() => {
                                                setShowModal2(true),
                                                    setInfo({
