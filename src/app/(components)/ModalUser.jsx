    ...
    return (
        ...
        `}>
            <div className={`rounded-[10px] shadow-2xl  shadow-black/20 p-8 m-4 md:min-w-[700px] md:mx-auto bg-slate-800 `}>
                ...
                <form className="mb-4 py-4   w-full" action={async () => (await userAdmin(datos, info.tipo, info.id), setShowModal(false), toast.success('El evento fue agregado con exito!!!'))} >
