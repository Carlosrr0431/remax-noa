...
export const FooterSencillo = () => {
    return (
        <footer className="bg-[#082f49] text-gray-600 py-4 px-6 ">
=======
...
<<<<<<< HEAD
                        <Link href={''} className="duration-300 transition-all hover:scale-105  focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] text-white  text-md font-light montserrat hover:font-medium "> Nosotros  </Link>

                        <Link href={''} className="duration-300 transition-all hover:scale-105  focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] text-white font-light text-md montserrat hover:font-medium"> Oficinas </Link>
                        <Link href={''} className="duration-300 transition-all hover:scale-105  focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] text-white font-light montserrat text-md hover:font-medium"> Comunidad RE/MAX </Link>
=======
